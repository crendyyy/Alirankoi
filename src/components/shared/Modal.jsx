...
const Backdrop = (props) => {
  return (
    <div
      className="fixed top-0 left-1/2 transform -translate-x-1/2 h-screen w-1/3 max-[1080px]:w-full flex justify-center items-center z-[55] bg-black opacity-60"
...
const Overlay = (props) => {
  return (
    <motion.div
      ...
      className="fixed left-2/4 bottom-[-303px] z-[60] max-[1080px]:w-full overflow-hidden m-auto w-1/3"
    >
      {props.children}
    </motion.div>
  );
